...
class CreateCustomer {
  ...
  fillPersonalData(customerPersonalData: any) {
    ...
    cy.get(PersonalData.phone)
      .clear()
      .type(customerPersonalData.phone.ddd + customerPersonalData.phone.number);
    cy.get(PersonalData.phoneType).select(customerPersonalData.phone.phoneType);
  ...
  fillDeliveryAddress(deliveryAddress: any) {
    ...
    cy.get(DeliveryAddress.residenceType).select(deliveryAddress.residenceType);
